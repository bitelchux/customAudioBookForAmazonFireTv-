...
(function(exports) {
    ...
    function PlayerView(settings) {
        ...
        this.render = function ($container, data, index) {
            ...
            this.thumbnailImage.className = 'player-audio-thumb';
            this.thumbnailImage.src = video_data.thumbURL;
            
            this.customContainer = document.createElement('div');
            this.customContainer.className = 'audio-player';
            ...
            <button class="btns" id="playbtn"><img id="playPauseImg" class="ImgBtns" src="assets/pause.png"></button>
            <button class="btns" id="forwardbtn"><img class="ImgBtns"  src="assets/forward.png"></button>
            <button class="btns" id="decspeed"><img class="ImgBtns" src="assets/decspeed.png"></button>
            <button class="btns" id="nspeed"><img id="playPauseImg" class="ImgBtns" src="assets/speed.png"></button>
            ...
            this.$el.append( this.vidtitle);
            this.$el.append( this.customContainer);
            ...
            this.knownPlayerErrorTriggered = false;
                        ...
                        this.playbtn.addEventListener("click", this.customplay);
            
                        this.rewindbtn = document.getElementById("rewindbtn");
            
                        this.rewindbtn.addEventListener("click", this.customRewind);
            
                        this.forwardbtn = document.getElementById("forwardbtn");
            
                        this.forwardbtn.addEventListener("click", this.customForward);

                        this.decspeed = document.getElementById("decspeed");
            
                        this.decspeed.addEventListener("click", this.customDecspeed);

                        this.nspeed = document.getElementById("nspeed");
            
                        this.nspeed.addEventListener("click", this.customNspeed);
        ...
        this.handleClosedCaptioning = function(tracks) {
            ...
            this.customRewind = function(){
                  
                        let vid = document.getElementsByClassName("player-content-video")[0];
                        vid.currentTime -= 2;
            }.bind(this);
 
            this.customForward = function(){
                        let vid = document.getElementsByClassName("player-content-video")[0];
                        vid.currentTime += 2;
            }.bind(this);
 
            this.customDecspeed = function(){
                        let vid = document.getElementsByClassName("player-content-video")[0];
            ...
            this.customNspeed = function(){
                        let vid = document.getElementsByClassName("player-content-video")[0];
                        vid.playbackRate = 1;
            }.bind(this);
 
            this.customIncspeed = function(){
                        let vid = document.getElementsByClassName("player-content-video")[0];
                       if(vid.playbackRate <= 3.75)
                       {
                        vid.playbackRate += 0.25;
                       }
            }.bind(this);
